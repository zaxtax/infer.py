...
sys.path.append(r'/home/zv/upstream/InferNET/Bin')
...
class InitArray : 
    ...
    def _upcast_type(cls, clrTypeName):
       if clrTypeName == MicrosoftResearch.Infer.Maths.DenseVector:
            return Vector
       elif clrTypeName == MicrosoftResearch.Infer.Maths.SparseVector:
            return Vector
       else :
           return clrTypeName
